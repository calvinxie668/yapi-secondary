...
const socketMockController = require('./controllers/socketMock.js');
const cronController = require('./controllers/cron.js');
...
let INTERFACE_CONFIG = {
  ...
  socketMock: {
    prefix: '/mock/',
    controller: socketMockController
  },
  cron: {
    prefix: '/cron/',
