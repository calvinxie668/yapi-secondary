            ...
            <FormItem className="interface-edit-item" {...formItemLayout} label="接口类型">
             {
               getFieldDecorator('method', {
                 ...
                 rules: [{ required: true, message: '请选择一个接口类型' }]
               })(
                 <Select placeholder="请选择一个接口类型">
          ...
          <Fragment>
            ...
            >
              {getFieldDecorator('req_msg_body', {
                initialValue: this.state.req_msg_body,
                rules: [{
            ...
            >
              {getFieldDecorator('res_msg_body', {
                initialValue: this.state.res_msg_body,
                rules: [{
                  required: true, message: '请输入返回结果消息类型!'
                }]
              })(
        ...
        <Fragment>
          ...
          >
            {getFieldDecorator('push_msg_type', {
              initialValue: this.state.push_msg_type,
              rules: [{
          ...
          >
            {getFieldDecorator('push_msg_body', {
              initialValue: this.state.push_msg_body,
              rules: [{
