...
const contentRouter = {
  path: '/project/:id/socket/:action/:actionId',
  exact: true
};
...
const InterfaceRoute = props => {
  ...
  if (props.match.params.action === 'api') {
    ...
    props.history.replace('/project/' + params.id + '/socket/api');
    return null;
  }
  return <C {...props} />;
};
        ...
        <Sider style={{ height: '100%' }} width={300}>
          <div className="left-menu">
            <Tabs type="card" className="tabs-large" activeKey={activeKey} onChange={this.onChange}>
              <Tabs.TabPane tab="socket接口列表" key="api" />
        ...
        <Layout>
          ...
          >
            <div className="right-content">
              <Switch>
                <Route exact path="/project/:id/socket/:action" component={InterfaceRoute} />
